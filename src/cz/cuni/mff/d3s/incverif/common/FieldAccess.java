...
public class FieldAccess
{
	...
	public FieldAccess(FieldID tgtField, ProgramPoint pp)
	{
		this.targetField = tgtField;
	...
	public boolean equals(Object obj)
	{
		...
		if ( ! this.targetField.equals(other.targetField) ) return false;
	...
	public int hashCode()
	{
		if (hc == 0)
		{
			hc = hc * 31 + this.targetField.hashCode();
	...
	public String toString()
	{
		...
		strbuf.append(targetField.toString());
		strbuf.append(" # ");
